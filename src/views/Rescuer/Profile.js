                            ...
                            <Card.Body>
                                <div className="author">
                                    <a href="#pablo" onClick={(e) => e.preventDefault()}>
                                        {this.state.profile.gender === true ? <img
                                            alt="..."
                                ...
                                <Row>
                                    <Col>
                                        <p className="text-center"><label>Địa chỉ:{" "}</label> {this.state.profile.address}, {this.state.profile.city}, {this.state.profile.country}</p>
                                    </Col>
                                </Row>
