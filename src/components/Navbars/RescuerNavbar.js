...
import routes from "../Sidebar/RescuerSidebarRoutes";
function auth() {
    ...
    return (
      <Dropdown as={Nav.Item}>
        ...
        <Dropdown.Menu aria-label="navbarDropdownMenuLink">
          {/* <Dropdown.Item href="/rescuer/profile" tag={Link}>
            Profile
          </Dropdown.Item> */}
          <Dropdown.Item href="/rescuer/edit-profile" tag={Link}>
      ...
      <Container fluid>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="nav mr-auto" navbar>
            {/* <Nav.Item>
              <Nav.Link href="/rescuer/map/" className="m-0">
                <i className="nc-icon nc-map-big" style={{ fontSize: 20 }}></i>
                <span style={{ marginLeft: 5 }}>Map</span>
              </Nav.Link>
            </Nav.Item>
            <Nav.Item>
              <Nav.Link href="/rescuer/register" className="m-0">
                <i className="nc-icon nc-paper-2" style={{ fontSize: 20 }}></i>
                <span style={{ marginLeft: 5 }}>Register</span>
              </Nav.Link>
            </Nav.Item>
            <Nav.Item>
              <Nav.Link href="/rescuer/warehouse" className="m-0">
                <i className="nc-icon nc-paper-2" style={{ fontSize: 20 }}></i>
                <span style={{ marginLeft: 5 }}>Warehouse</span>
              </Nav.Link>
            </Nav.Item> */}
          </Nav>
